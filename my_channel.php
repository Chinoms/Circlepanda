...
<html>
  <head>
    <meta charset="utf-8">
    <title><?php echo $last_name . "'s"; ?> Channels</title>
    <?php
  ...
  <body>
    ...
    <section class="house">
      ...
      <?php
        $data['url'] = BASE_URL . "module/channel/create_channel";
        $data['name'] = "Channel";
        $data['type_tag'] = "Choose channel type";
        $name['c_name'] = "channel_name";
        $name['c_view'] = "channel_view";
        $name['c_about'] = "about_channel";
        $name['c_cover'] = "channel_cover";
        $name['c_type'] = "channel_type";
        $name['c_color'] = "channel_color";
      ...
      <div class="postarea_plus">
        ...
        $fetch = "SELECT * FROM channel WHERE user_id='$user_id'";
        $result = mysqli_query($conn, $fetch);
          while ($row = mysqli_fetch_array($result)) {
            echo '<a href="'. BASE_URL .'channel_home?id='. $row['channel_id'] .'" class="display-box channeltext" style="background-color:'.$row['channel_color'].'">
