...
<html>
  <head>
    <meta charset="utf-8">
    <title> Suggested Channels </title>
    <?php
      include_once 'metas/seo.php';
      $desc = "Let Circlepanda find you the best Channel";
  ...
  <body>
    ...
    <section class="house">
      ...
      <div class="postarea_plus">
        ...
        $fetch = "SELECT * FROM channel WHERE channel_view='Public'";
