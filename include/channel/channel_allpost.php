<?php
$grab = "SELECT * FROM join_channel j JOIN	channel_post p ON j.channel_id = p.channel_id WHERE j.user_id='$user_id' ORDER BY post_id DESC LIMIT 10";
  ...
  while ($post = mysqli_fetch_array($result)) {
    echo '<div class="box">
      ...
      <div class="w3-container">
        <a href="#like" class="icon-below w3-circle left-float space ' . checkchannellike($conn, $post['post_id'], $user_id) . ' channel-like" data-postid="' . $post['post_id'] . '" data-channelid="' . $post['channel_id'] . '">
        ...
        <a tabindex="channel" class="icon-below w3-circle float-right space comment">
