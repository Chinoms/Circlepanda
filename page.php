...
<html>
  ...
  <body>
    ...
    <section class="house">
      ...
      <?php
        $data['url'] = BASE_URL . "module/page/create_page";
        $data['name'] = "Page";
        $data['type_tag'] = "Choose page type";
        $name['c_name'] = "page_name";
        $name['c_view'] = "page_view";
        $name['c_about'] = "about_page";
        $name['c_cover'] = "page_cover";
        $name['c_type'] = "page_type";
        $name['c_color'] = "page_color";
      ...
      <div class="postarea_plus">
        ...
        $fetch = "SELECT * FROM page WHERE user_id='$user_id'";
