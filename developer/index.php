...
<html>
  <head>
    <meta charset="utf-8">
    <title> Circlepanda Developers </title>
    <?php
    include_once '../metas/external_seo.php';
    $desc = "Circlepanda helps Developers build, grow, and manage Apps and Promote Innovation Challenges.";
    $keyword = "Circlepanda, Network, Social, Development, Technology, Programming, Version, Codes, Trends, App, Web, Product, Integrations, Search, Api, Unity, Curl, Php, Python, Ruby, Go, Erlang, Javascript, Node.js, Angular Js, C++, Java, Kotlin, More";
  ...
  <body>
    ...
    <section class="banner w3-container top">
      ...
      <div class="w3-padding-24">
        <a href="<?php echo BASE_URL . "developer/getstarted" ?>" class="ui blue large button" type="button" name="button">
          Get Started
        </a>
      </div>
    </section>
    <section class="banner w3-container w3-center">
      <div class="w3-container">
        ...
        <div class="w3-col s12 m3">
          <i class="material-icons md-72">show_chart</i>
          <h3>Analytics</h3>
        </div>
        <div class="w3-col s12 m3">
      ...
      <div class="w3-padding-48 w3-center">
        <a href="<?php echo BASE_URL . "developer/doc" ?>" class="ui blue medium button" type="button" name="button">
          View all docs
        </a>
      </div>
    </section>
