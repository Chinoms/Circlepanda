<?php
  ...
  include_once '../module/ad/adinfo.php';
  ...
  <section class="ad_inner_container w3-padding-32">
    <section class="ad_midform_wrapper ui">
      ...
      <div class="ui mini steps">
        ...
        <div class="completed step steptrack-two">
          <i class="info icon"></i>
          <div class="content">
        ...
        <div class="completed step steptrack-three">
        ...
        <div class="active step steptrack-four">
        ...
        <div class="disabled step steptrack-five">
          ...
          <div class="content">
            ...
            <div class="description">Go Live</div>
          </div>
        </div>
      </div>
      ...
      <div class="w3-container w3-padding-8">
        <?php
          ...
          class addCalc {
            public $val = '100';
              public function calc($amt) {
                # Calc using BODMAS Principle (Mathematical Formula)
                return $this->val * $amt;
              }
          }
          ...
          $total = new addCalc;
          $amt = $total->calc('1000');
          include_once 'steps/stepfour.php';
        ?>

        <div class="w3-container w3-center">
          <a href="<?php echo BASE_URL . "ad/publish" ?>" class="field w3-center w3-padding-8 paycont hide">
