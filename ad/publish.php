<?php
  ...
  include_once '../function/ad/btn.php';
  ...
  <section class="ad_inner_container w3-padding-32">
    <section class="ad_midform_wrapper ui">
      ...
      <div class="ui mini steps">
        ...
        <div class="completed step steptrack-four">
        ...
        <div class="active step steptrack-five">
          <i class="rocket icon"></i>
          <div class="content">
            <div class="title">Publish</div>
            <div class="description">Go live <i class="thumbs up icon"></i></div>
          </div>
        </div>
      </div>
      ...
      <div class="w3-container w3-padding-8">
        <?php
          # Ad Publish
          include_once 'steps/stepfive.php';
        ?>
      </div>
    </section>
  </section>
