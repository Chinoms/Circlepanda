...
<html>
  <head>
    ...
    <?php
      ...
      $desc = "Find people you may know on Circlepanda. Browse our directory";
      $keyword = "Circlepanda, Social, Network, People, Family, Friends, Meet, Team, Channel, Collection, Page, Community, Creativity, Fun, Memories, Ideas, Status, Colorful, Family, Friends, Panda, Circle, Group, Partner, People, Blue, Simple, Search, Tools, Images, API, More";
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL . "asset/css/media/people.media.css" ?>">
    ...
    <section class="house">
      ...
      <div class="postarea_plus">
        <?php
          ...
          $fetch = "SELECT * FROM users WHERE confirmed='1'";
